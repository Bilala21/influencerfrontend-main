  ...
  if (loading) {
    ...
    return (
      <>
        ...
        <section className='lg:py-20 py-10'>
          <div className='container mx-auto'>
            <div className='flex flex-wrap items-center justify-between'>
              ...
              <NavLink to='/' className='text-base font-bold items-center gap-x-2 lg:flex hidden'>See More
          ...
          <div className='container mx-auto'>
            <div className='sm:flex items-center justify-between'>
              ...
              <div className='flex items-center gap-x-10 lg:justify-start justify-center lg:py-0 py-5'>
                ...
                <NavLink to='/' className=' border border-primary-dark lg:flex hidden justify-center gap-x-3 items-center text-primary-dark rounded-full text-base font-bold text-center py-[14px] w-[208px]'>
                  View all Issuers
            ...
            <div className='flex justify-between items-center bg-primary-sea-green-200 rounded-lg md:px-[80px] lg:flex-row flex-col'>
              <div className='max-w-[650px]'>
                ...
                <div className='flex items-center gap-x-3 pt-7 lg:justify-start justify-center'>
                  <a className="px-5 py-2 border border-primary-dark flex justify-center gap-x-3 items-center bg-primary-dark text-white rounded-full text-base font-bold text-center lg:py-[17px] lg:px-8" href="/">Find Bonds<img src={`${base_path_icon}/right-up.svg`} alt="icon" /></a>
                  <a className="px-5 py-2 border border-primary-dark flex justify-center gap-x-3 items-center text-primary-dark rounded-full text-base font-bold text-center lg:py-[18px] lg:px-8" href="/">Find Talent<img src={`${base_path_icon}/right-up-black.svg`} alt="icon" /></a>
                </div>
              </div>
        ...
        <section className='lg:py-[120px] pt-[50px]'>
